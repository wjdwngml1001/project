  ...
  contents: [
    ...
    },
    {
      ...
      contents: [
        ...
        { kind: 'block', type: 'motion_change_x_by' },
        { kind: 'block', type: 'motion_change_y_by' },
        { kind: 'block', type: 'motion_move_xy_by_time' },
        { kind: 'block', type: 'motion_goto_x' },
        { kind: 'block', type: 'motion_goto_y' },
        { kind: 'block', type: 'motion_goto_xy' },
        { kind: 'block', type: 'motion_glide_xy' },
        { kind: 'block', type: 'motion_turn_right' },
        { kind: 'block', type: 'motion_turn_left' },
        { kind: 'block', type: 'motion_rotate_by_angle' },
        { kind: 'block', type: 'motion_rotate_by_angle_time' },
        { kind: 'block', type: 'motion_move_in_direction' },
      ],
    },
    {
      kind: 'category',
      ...
      contents: [
        ...
        { kind: 'block', type: 'looks_clear' },
        { kind: 'block', type: 'looks_change_size_by' },
        { kind: 'block', type: 'looks_set_size_to' },
        { kind: 'block', type: 'looks_size_default' },
        { kind: 'block', type: 'looks_flip_vertical' },
        { kind: 'block', type: 'looks_flip_horizontal' },
      ],
    },
    {
      kind: 'category',
