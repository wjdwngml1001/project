...
export function registerBlocks() {
  ...
  Blockly.Blocks['motion_if_on_edge_bounce'] = {
    init: function () {
      this.appendDummyInput().appendField('화면 끝에 닿으면 튕기기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#4C97FF');
    },
  ...
  // N초 동안 x: N y: N만큼 움직이기
  Blockly.Blocks['motion_move_xy_by_time'] = {
    init: function () {
      this.appendDummyInput()
        .appendField(new Blockly.FieldNumber(1, 0, 9999, 0.1), 'SEC')
        .appendField('초 동안 x:')
  ...
  // x: N 위치로 이동하기
  Blockly.Blocks['motion_goto_x'] = {
    init: function () {
      this.appendDummyInput()
        .appendField('x:')
        .appendField(new Blockly.FieldNumber(0, -1000, 1000, 1), 'X')
  ...
  // y: N 위치로 이동하기
  Blockly.Blocks['motion_goto_y'] = {
    init: function () {
      this.appendDummyInput()
        .appendField('y:')
        .appendField(new Blockly.FieldNumber(0, -1000, 1000, 1), 'Y')
        .appendField(' 위치로 이동하기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#4C97FF');
  ...
  // 방향을 N'(각도)만큼 회전하기
  Blockly.Blocks['motion_rotate_by_angle'] = {
    init: function () {
      this.appendDummyInput()
        .appendField('방향을')
  ...
  // N초 동안 방향을 N'(각도)만큼 회전하기
  Blockly.Blocks['motion_rotate_by_angle_time'] = {
    init: function () {
      this.appendDummyInput()
        .appendField(new Blockly.FieldNumber(1, 0, 9999, 0.1), 'SEC')
        .appendField('초 동안 방향을')
        .appendField(new Blockly.FieldNumber(90, -360, 360, 1), 'ANGLE')
        .appendField('도 회전하기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
  ...
  // N' 방향으로 N만큼 움직이기
  Blockly.Blocks['motion_move_in_direction'] = {
    init: function () {
      this.appendDummyInput()
        .appendField(new Blockly.FieldNumber(90, -360, 360, 1), 'ANGLE')
        .appendField('도 방향으로')
  ...
  Blockly.Blocks['looks_say_for_secs'] = {
    init: function () {
      this.appendDummyInput()
        .appendField(new Blockly.FieldTextInput('안녕!'), 'TEXT')
        .appendField('을(를)')
        .appendField(new Blockly.FieldNumber(2, 0, 9999, 0.1), 'SEC')
        .appendField('초 동안 말하기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#FF66CC');
    },
  ...
  // 말풍선 지우기
  Blockly.Blocks['looks_clear'] = {
    init: function () {
      this.appendDummyInput().appendField('말풍선 지우기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#FF66CC');
    },
  ...
  Blockly.Blocks['looks_change_size_by'] = {
    init: function () {
      this.appendDummyInput()
        .appendField('크기를')
        .appendField(new Blockly.FieldNumber(10, -1000, 1000, 1), 'DELTA')
        .appendField('만큼 바꾸기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#FF66CC');
  ...
  // 원래 크기로 되돌리기
  Blockly.Blocks['looks_size_default'] = {
    init: function () {
      this.appendDummyInput().appendField('원래 크기로 되돌리기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#FF66CC');
    },
  ...
  // 상하 모양 뒤집기
  Blockly.Blocks['looks_flip_vertical'] = {
    init: function () {
      this.appendDummyInput().appendField('상하 모양 뒤집기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#FF66CC');
    },
  ...
  // 좌우 모양 뒤집기
  Blockly.Blocks['looks_flip_horizontal'] = {
    init: function () {
      this.appendDummyInput().appendField('좌우 모양 뒤집기');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour('#FF66CC');
    },
